...
const Contact = () => {
  return (
    <div className="container m-auto px-2 md:px-12 lg:px-7 pt-4">
      <h1 className="text-indigo-600 mb-2">Contact Us</h1>
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div className="bg-white relatiLorem Ipsum is simply dummy text of the printing and typesetting industry.ve flex flex-wrap py-6 rounded shadow-md">
          ...
          <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <p className="text-xs text-gray-500 mt-3">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
          </div>
        </div>
      </section>
    </div>
